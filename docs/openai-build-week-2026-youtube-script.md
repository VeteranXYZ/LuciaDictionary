...
>
> During Build Week, I added Classroom Relay. It uses local review dates, mastery, past results, and classroom encounters to select up to five words—and it explains every choice.
>
...
- Put the strongest proof—working flow, Codex/GPT-5.6 statement, repository, and Session ID—inside the video rather than only in the YouTube description.
